...
<body>
    ...
    <a href="html/admin/dashboardAdmin.php"><button>cadmin</button></a>
    <a href="html/user/dashboardUtilisateur.php"><button>dash User</button></a>
    <a href="html/photo/photos.php"><button>photos</button></a>
    <a href="html/event/lesEvents.php"><button>evenements</button></a>
</body>
</html>
